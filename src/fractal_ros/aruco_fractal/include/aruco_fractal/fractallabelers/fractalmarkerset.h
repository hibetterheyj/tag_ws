...
public:
   ...
   */
  bool isNormalize() const { return mInfoType == NORM; }

  // Normalize fractal marker. The corners will go on to take the values
  // (-1,1)(1,1),(1,-1)(-1,-1)
  ...
  // variable indicates if the data is expressed in meters or in pixels or are
  // normalized
